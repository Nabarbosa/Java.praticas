package com.senai.Atividade.API.REST.com.Spring.Boot.service;

import com.senai.Atividade.API.REST.com.Spring.Boot.exception.EmailJaCadastradoException;
import com.senai.Atividade.API.REST.com.Spring.Boot.model.Funcionario;
import com.senai.Atividade.API.REST.com.Spring.Boot.repository.FuncionarioRepository;
...
public class FuncionarioService {
    ...
    public Funcionario salvar(@Valid Funcionario funcionario) {
        if (funcionarioRepository.findByEmail(funcionario.getEmail()).isPresent()) {
            throw new EmailJaCadastradoException("Funcionário já está cadastrado.");
        }
